...
function init_gear_sets()
	...
	-- Capes
		BP_cape = { name="Campestres's Cape", augments={'Summoning magic skill +3','Pet: Enmity+10','Blood Pact Dmg.+5',}}
		Delay_cape = { name="Campestres's Cape", augments={'Summoning magic skill +1','Pet: Enmity+12','Blood Pact ab. del. II -2',}}
    ...
    sets.precast.WS['Shattersoul'] = {
        head="",
        body="",hands="",
        back="",waist="Fucho-no-Obi",legs="Assiduity Pants +1",feet=""}
    ...
    sets.midcast['Dark Magic'] = {main= "Was",
