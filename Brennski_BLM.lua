function get_sets()
        ...
        sets.Idle.Standard = {ammo="Staunch Tathlum", main ="Lathi",
		...
		sets.Nuke ={}
			...
			sets.Nuke.Standard = {main ="Lathi",ammo="Pemphredo Tathlum",
			...
			sets.Nuke.MagicBurst = {main ="Lathi",ammo="Pemphredo Tathlum",
