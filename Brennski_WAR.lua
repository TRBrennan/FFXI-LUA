function get_sets()
        ...
        sets.Idle.Standard = {ammo="Brigantia Pebble",
                                      ...
                                      body="Emet harness +1",hands="Garden Bangles",ring1="Warden's ring",ring2="Sheltered ring",
        ...
        sets.TP = {}
           ...
           sets.TP.index = {'Standard', 'AccuracyLite', 'AccuracyFull', 'DT', 'DTAccuracy'}
				...
				sets.TP.Standard = {ammo="Seething Bomblet +1",
                                    head="Sulevia's Mask +1", neck="Lissome necklace", ear1="Brutal Earring",ear2="Cessance Earring",
                                    body="Sulevia's Platemail +1",hands="Sulevia's Gauntlets +1",ring1="Petrov Ring",ring2="Cacoethic Ring",
                                    back="Cichol's Mantle",waist="Kentarch Belt +1",legs="Odyssean Cuisses",feet="Valorous Greaves"}
                                                       
                                                       
                sets.TP.AccuracyLite = {ammo="Ginsen",
                                        head="Sulevia's Mask +1",neck="Lissome necklace", ear1="Suppanomimi", ear2="Cessance Earring",                            
										body="Thaumas coat",hands="Sulevia's Gauntlets +1",ring1="Petrov Ring",ring2="Cacoethic Ring",
                                        back="Cichol's Mantle",waist="Kentarch Belt +1",legs="Odyssean Cuisses",feet="Valorous Greaves"}
       
                sets.TP.AccuracyFull = {ammo="Ginsen",
                                        head="Dampening Tam",neck="Sanctity Necklace", ear1="Dignitary's Earring", ear2="Cessance Earring",
                                        body="Sulevia's Platemail +1",hands="Sulevia's Gauntlets +1",ring1="Cacoethic Ring",ring2="Gelatinous Ring +1",
                                        back="Cichol's Mantle",waist="Kentarch Belt +1",legs="Odyssean Cuisses",feet="Valorous Greaves"}
       ...
       --Weaponskill Sets--
		...
		sets.Ukkos.Atack = {ammo="Seething Bomblet +1",
                                    head="Sulevia's Mask +1", neck="Fotia Gorget", ear1="Brutal Earring",ear2="Cessance Earring",
                                    body="Sulevia's Platemail +1",hands="Sulevia's Gauntlets +1",ring1="Petrov Ring",ring2="Begrudging Ring",
                                    back="Cichol's Mantle",waist="Fotia Belt",legs="Odyssean Cuisses",feet="Valorous Greaves"}
        ...
        sets.Utility.Steps = {ammo="Ginsen",
							head="Sulevia's Mask +1", body="Sulevia's Platemail +1", hands="Rawhide Gloves",legs=="Odyssean Cuisses", feet="Valorous Greaves", neck="Subtlety Spec.",waist="Chaac Belt", left_ear="Heartseeker Earring",right_ear="Dignitary's Earring", left_ring="Yacuruna Ring", right_ring="Cacoethic Ring",  back="Cichol's Mantle",}
