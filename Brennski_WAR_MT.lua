function get_sets()
        ...
        sets.Idle.DT = { ammo="Staunch Tathlum +1", 
							head="Sulevia's Mask +2",neck="Loricate Torque +1", ear1="Eabani earring", ear2="Infused Earring",
                              body="Souveran Cuirass",hands="Sulev. Gauntlets +2",ring2="Moonlight Ring",ring1="Defending Ring",
        ...
        sets.TP = {}
           ...
           sets.TP.index = {'Standard', 'AccuracyMid', 'AccuracyFull', 'DT', 'DTAccuracy', "Tank"}
                ...
                sets.TP.AccuracyFull = {ammo="Seething Bomblet +1",
                                        ...
                                        body={ name="Valorous Mail", augments={'Accuracy+21 Attack+21','STR+10','Accuracy+15','Attack+4',}},hands="Flam. Manopolas +1",ring1="Cacoethic Ring",ring2="Chirich Ring +1",
                                         back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10',}},
										 waist="Ioskeha Belt",legs={ name="Odyssean Cuisses", augments={'Accuracy+16 Attack+16','"Store TP"+7','DEX+2','Attack+8',}},
										feet="Pummeler's Calligae +3"}
                ...
                sets.TP.DT = {ammo="Staunch Tathlum +1",
                              ...
                              body="Souveran Cuirass",hands="Sulev. Gauntlets +2",ring1="Moonlight Ring",ring2="Defending Ring",
                               back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10',}},
       ...
       --Weaponskill Sets--
		...
		sets.Ukkos.Atack = {ammo="Yetshila",
                                    ...
                                    body={ name="Valorous Mail", augments={'Accuracy+21 Attack+21','STR+10','Accuracy+15','Attack+4',}},hands="Argosy Mufflers +1",ring1="Niqmaddu Ring",ring2="Regal Ring",
                                     back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10',}},
									 waist="Sailfi Belt +1",legs="Sulevia's Cuisses +2",
		...
		sets.Upheavel.AttackLowTP = {ammo="Knobkierrie", head="Sulevia's Mask +2",neck="Fotia Gorget", ear1="Moonshade Earring",ear2="Telos Earring",
									  body="Sulevia's Plate. +2",hands="Sulev. Gauntlets +2",ring1="Regal Ring",ring2="Niqmaddu Ring",
									   ...
									   waist="Sailfi Belt +1",legs="Sulevia's Cuisses +2",feet="Pummeler's Calligae +3"}
	    ...
	    sets.NINMagic.Utsusemi ={
                              ...
                              body="Emet harness +1",hands="Sulev. Gauntlets +2",ring1="Moonlight Ring",ring2="Petrov Ring",
