function get_sets()
        ...
        sets.TP = {}
           ...
           sets.TP.index = {'Standard'}
				...
				sets.TP.Standard = {main ="Akademos",sub ="Enki Strap",ammo="Homiliary",
                                      ...
                                      waist="Fucho-no-obi",legs="Assiduity Pants",feet="Chironic Slippers", back ="Moonbeam Cape"}
		...
		sets.WS.Myrkr ={ammo="Strobilus",
                                 ...
                                 body="Amalric Doublet",hands="Amalric Gages", ring1="Mephitas's Ring", ring2 ="Rahab Ring", waist ="Refoccilation Stone",
		...
		sets.Nuke ={}
			...
			sets.Nuke.Standard = {main={ name="Malevolence", augments={'INT+10','Mag. Acc.+10','"Mag.Atk.Bns."+10','"Fast Cast"+5',}},
									sub="Ammurapi Shield",
									ammo="Hydrocera",
			...
			sets.Nuke.MagicBurst = {main={ name="Malevolence", augments={'INT+10','Mag. Acc.+10','"Mag.Atk.Bns."+10','"Fast Cast"+5',}},
									sub="Ammurapi Shield",
									ammo="Hydrocera",
									head={ name="Merlinic Hood", augments={'Mag. Acc.+17 "Mag.Atk.Bns."+17','Magic burst dmg.+9%','CHR+6','Mag. Acc.+14',}},
									body="Jhakri Robe +2",
		...
		sets.Enhancing ={}
			...
			sets.Enhancing.Normal = { main="Gada",
									sub="Ammurapi Shield",
									ammo="Homiliary",
			...
			sets.Enhancing.Storms = {  main="Gada",
									sub="Ammurapi Shield",
									ammo="Homiliary",
									head={ name="Telchine Cap", augments={'Enh. Mag. eff. dur. +9',}},
									body={ name="Telchine Chas.", augments={'Enh. Mag. eff. dur. +7',}},
		...
		sets.Magic ={}
			...
			sets.Magic.Enfeebling = {main="Malevolence",
									sub="Ammurapi Shield",
									ammo="Hydrocera",
									head="Befouled Crown",
									body="Shango Robe",
			...
			sets.Magic.Healing = { main="Vadose Rod",
								sub="Ammurapi Shield",
								ammo="Esper Stone",
			...
			sets.Magic.Regen = { main = "Bolelabunga",
								sub="Ammurapi Shield",
								...
								legs={ name="Telchine Braconi", augments={'Enh. Mag. eff. dur. +9',}},
								feet={ name="Telchine Pigaches", augments={'Enh. Mag. eff. dur. +9',}},   
                                 neck="Incanter's Torque ",ear1 ="Regal Earring", ear2="Regal Earring",
			...
			sets.Magic.Dark = { ammo="Pemphredo Tathlum",
                                 ...
                                 body={ name="Merlinic Jubbah", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','INT+7','Mag. Acc.+14','"Mag.Atk.Bns."+14',}},hands="Jhakri Cuffs +2", ring1="Evanescence Ring", ring2 ="Shiva Ring", waist ="Refoccilation Stone",
		...
		sets.Utility.DrainAspir = { ammo="Pemphredo Tathlum",
                                 ...
                                 body={ name="Merlinic Jubbah", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','INT+7','Mag. Acc.+14','"Mag.Atk.Bns."+14',}},hands="Jhakri Cuffs +2", ring1="Evanescence Ring", ring2 ='Shiva Ring', waist ="Fucho-no-obi",
                                 back="Lugh's Cape",legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Mag. crit. hit dmg. +1%','Mag. Acc.+11','"Mag.Atk.Bns."+13',}},
								 feet="Merlinic Crackows"}
