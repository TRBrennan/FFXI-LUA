function get_sets()
    ...
    back={ name="Intarabus's Cape", augments={'CHR+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}},
	    ...
	    sets.precast.WS = {}
    sets.Evisceration = { head="Lustratio cap",
    body="Ayanmo Corazza +1",
    hands="Lustratio mittens",
    ...
    sets.midcast.Haste = {main="Grioavolr",sub="Fulcio grip",
		head="Vanya Hood",neck="Nodens gorget",ear1="Enchanter Earring +1",ear2="Loquac. Earring",
		body="Inyanga jubbah +1",hands="Kaykaus cuffs",ring1="Rahab Ring",ring2="kishar Ring",
		 back={ name="Intarabus's Cape", augments={'CHR+20','System: 1 ID: 80 Val: 19','Mag. Acc.+10','"Fast Cast"+10',}},waist="Siegel Sash",legs="Chironic hose",feet="Kaykaus boots"}	
		
    sets.midcast.Debuff ={main="Carnwenhan",sub="Genmei shield",
    range="Gjallarhorn",
    ...
    right_ring="Carb. Ring +1",
     back={ name="Intarabus's Cape", augments={'CHR+20','System: 1 ID: 80 Val: 19','Mag. Acc.+10','"Fast Cast"+10',}},
}


    sets.midcast.Threnody= { main="Carnwenhan",sub="Genmei shield",
    range="Gjallarhorn",
    head="Brioso roundlet +3",
    body="Brioso Justau. +3",
    hands="Brioso cuffs +3",
    ...
    sets.midcast.Buff = {main="Carnwenhan",sub="Genmei shield",head="Fili Calot +1",neck="Moonbow whistle +1",
        body="Fili Hongreline +1",hands="Fili Manchettes +1",legs="Inyanga Shalwar +2",feet="Brioso Slippers +3"}
		
	sets.midcast.Cure = {main={ name="Grioavolr", augments={'Enh. Mag. eff. dur. +10','Mag. Acc.+4','"Mag.Atk.Bns."+18',}},sub="Fulcio grip",
		head="Vanya Hood",neck="Nodens gorget",ear1="Enchanter Earring +1",ear2="Loquac. Earring",
		body="Heka's Kalasiris",hands="Kaykaus cuffs",ring1="Rahab Ring",ring2="kishar Ring",
	 back={ name="Intarabus's Cape", augments={'CHR+20','System: 1 ID: 80 Val: 19','Mag. Acc.+10','"Fast Cast"+10',}},waist="Hachirin-no-obi",legs="Chironic hose",feet="Kaykaus boots"}		
		
		
	sets.midcast.Marsyas = {range="Marsyas",main="Carnwenhan",sub="Genmei shield",head="Fili Calot +1",neck="Moonbow whistle +1",
        body="Fili Hongreline +1",hands="Fili Manchettes +1",legs="Inyanga Shalwar +2",waist="Luminary sash",feet="Brioso Slippers +3", back={ name="Intarabus's Cape", augments={'CHR+20','System: 1 ID: 80 Val: 19','Mag. Acc.+10','"Fast Cast"+10',}},}	
    
	sets.midcast.Lullaby = {range="Marsyas",main="Carnwenhan",sub="Genmei shield",head="Brioso roundlet +3",neck="Moonbow whistle +1",
        body="Fili Hongreline +1",hands="Brioso cuffs +3",legs="Inyanga Shalwar +2",feet="Brioso Slippers +3", back={ name="Intarabus's Cape", augments={'CHR+20','System: 1 ID: 80 Val: 19','Mag. Acc.+10','"Fast Cast"+10',}},}
    ...
    sets.midcast.Stoneskin ={main="Oranyan",
		sub="Fulcio Grip",
    ...
    --Aftercast Sets
    sets.aftercast = {}
    sets.aftercast.Regen = {main="Carnwenhan",sub="Genmei shield",range="Marsyas",ammo=empty,
    head="Aya. Zucchetto +1",
    body="Ayanmo Corazza +1",
    hands="Aya. Manopolas +1",
    ...
    sets.aftercast.PDT = {main="Carnwenhan",sub="Genmei shield",range="Marsyas",ammo=empty,
    head="Aya. Zucchetto +1",
    body="Ayanmo Corazza +1",
    hands="Aya. Manopolas +1",
    legs="Aya. Cosciales +1",
    ...
    sets.aftercast.Engaged = {main="Carnwenhan",sub="Genmei shield",range="Marsyas",ammo=empty,
     head="Aya. Zucchetto +1",
    body="Ayanmo Corazza +1",
    hands="Aya. Manopolas +1",
    legs="Aya. Cosciales +1",
