...
function get_sets()
	...
	sets.Nuke.Occult ={
		...
		sub="Ammurapi Shield",
		ammo = "Aurgelmir Orb +1",
		head={ name="Merlinic Hood", augments={'Mag. Acc.+30','"Occult Acumen"+11','CHR+6','"Mag.Atk.Bns."+5',}},
		body={ name="Merlinic Jubbah", augments={'"Mag.Atk.Bns."+17','"Occult Acumen"+7','Mag. Acc.+12',}},
