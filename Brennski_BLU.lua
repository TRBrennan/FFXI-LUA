function get_sets()
        ...
        sets.TP = {}
           ...
           sets.TP.index = {'Standard', 'AccuracyMid', 'AccuracyFull', 'DT', 'DTAccuracy'}
				...
				sets.TP.Standard = { ammo="Ginsen",
                                    ...
                                    back={ name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},waist="Reiki Koshiobi",legs="Samnuha Tights",feet={ name="Herculean Boots", augments={'Accuracy+20 Attack+20','"Triple Atk."+4',}} }
                ...
                sets.TP.DTAccuracy = {ammo="Ginsen",
                                      ...
                                      back={ name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},waist="Flume belt +1",legs="Aya. Cosciales +2",
									  feet="Ahosi Leggings" }
       ...
       --Weaponskill Sets--
        ...
        sets.WS.Expiacion = {ammo="Floestone",
                                          ...
                                          body={ name="Herculean Vest", augments={'Accuracy+25 Attack+25','Weapon skill damage +2%','STR+1','Attack+4',}},
										  hands={ name="Herculean Gloves", augments={'Accuracy+21 Attack+21','"Triple Atk."+2','STR+11','Accuracy+9',}},ring1="Ilabrat Ring",ring2="Rajas Ring",
