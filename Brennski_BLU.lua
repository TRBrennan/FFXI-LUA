...
function get_sets()
    ...
    sets.Idle.index = {'Standard', 'DT', 'Cleave' ,'Eva'}
    Idle_ind = 1
    ...
    sets.TP.index = {'Standard', 'AccuracyMid','AccuracyFull', 'DT','DTAccuracy','DTSB','EvaTank'}
    -- 1=Standard, 2 = AccuracyMid, 3=AccuracyFull, 4=DT, 5=DTAccuracy,6=DTSubtleBlow, 7=Evatank--
