function get_sets()
        ...
        sets.Idle.Standard = {ammo="Staunch Tathlum +1",
                                      ...
                                      body="Souveran Cuirass",hands="Sulev. Gauntlets +2",ring2="Defending ring",ring1="Chirich Ring +1",
        ...
        sets.TP = {}
           ...
           sets.TP.index = {'Standard', 'AccuracyMid', 'AccuracyFull', 'DT', 'DTAccuracy', "Tank"}
                ...
                sets.TP.DTAccuracy = {ammo="Staunch Tathlum +1",
       ...
       --Weaponskill Sets--
		...
		sets.Ukkos.Atack = {ammo="Yetshila",
                                    ...
                                    body={ name="Valorous Mail", augments={'Accuracy+20 Attack+20','"Store TP"+8','Accuracy+12','Attack+8',}},hands="Argosy Mufflers +1",ring1="Niqmaddu Ring",ring2="Regal Ring",
                                    back={ name="Cichol's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10',}},
									 waist="Sailfi Belt +1",legs="Argosy Breeches +1",
